...
func main() {
	...
	flag.BoolVar(&migrationContext.SkipSharedUniqueKey, "skip-shared-unique-key", false, "allow gh-ost to migrate without shared unique keys. As long as the new primary key is truly unique, this should be OK. If not, data may be corrupted. USE AT YOUR OWN RISK!")
